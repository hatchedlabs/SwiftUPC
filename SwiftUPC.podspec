...
structured barcode data from a string representation, as well as a custom UIKit view for displaying barcode data.
  ...
  s.homepage         = 'https://github.com/Cory Juhlin/SwiftUPC'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.authors          = { 'Hatched Labs' => 'ios-dev@hatchedlabs.com',
                         'Cory Juhlin' => 'cory@hatchedlabs.com' }
  s.source           = { :git => 'https://github.com/Cory Juhlin/SwiftUPC.git', :tag => s.version.to_s }
